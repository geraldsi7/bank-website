...
<div class="content">
    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-footer ">
            <button type="submit" class="btn btn-primary rounded-0">{{__('Save')}}</button>
          </div>
          <hr class="half-rule"/>
        </form>
      </div>
      ...
      <div class="card-body">
        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
          ...
          <div class="card-footer ">
            <button type="submit" class="btn btn-primary rounded-0 ">{{__('Change Password')}}</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <div class="col-md-4">
    <div class="card card-user">
      <div class="image">
        <img src="{{asset('assets')}}/img/bg-about.jpg" alt="...">
      </div>
      <div class="card-body">
        <div class="author">
          <a href="#">
          ...
          <p class="description font-weight-normal">
            {{ auth()->user()->email }}
          </p>
        </div>
      </div>
